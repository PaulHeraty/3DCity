...
GLmatrix glMatrixMultiply (GLmatrix a, GLmatrix b)
{
  ...
  M(result, 3,3) = M(a, 3,0) * M(b, 0,3) + M(a, 3,1) * M(b, 1,3) + M(a, 3,2) * M(b, 2,3) + M(a, 3,3) * M(b, 3,3);
    ...
    /*
  M(result, 0,0) = M(a, 0,0) * M(b, 0, 0) + M(a, 1,0) * M(b, 0, 1) + M(a, 2,0) * M(b, 0, 2) + M(a, 3,0) * M(b, 0,3);
  M(result, 1,0) = M(a, 0,0) * M(b, 1, 0) + M(a, 1,0) * M(b, 1, 1) + M(a, 2,0) * M(b, 1, 2) + M(a, 3,0) * M(b, 1,3);
  M(result, 2,0) = M(a, 0,0) * M(b, 2, 0) + M(a, 1,0) * M(b, 2, 1) + M(a, 2,0) * M(b, 2, 2) + M(a, 3,0) * M(b, 2,3);
  M(result, 3,0) = M(a, 0,0) * M(b, 3, 0) + M(a, 1,0) * M(b, 3, 1) + M(a, 2,0) * M(b, 3, 2) + M(a, 3,0) * M(b, 3,3);

  M(result, 0,1) = M(a, 0,1) * M(b, 0, 0) + M(a, 1,1) * M(b, 0, 1) + M(a, 2,1) * M(b, 0, 2) + M(a, 3,1) * M(b, 0,3);
  M(result, 1,1) = M(a, 0,1) * M(b, 1, 0) + M(a, 1,1) * M(b, 1, 1) + M(a, 2,1) * M(b, 1, 2) + M(a, 3,1) * M(b, 1,3);
  M(result, 2,1) = M(a, 0,1) * M(b, 2, 0) + M(a, 1,1) * M(b, 2, 1) + M(a, 2,1) * M(b, 2, 2) + M(a, 3,1) * M(b, 2,3);
  M(result, 3,1) = M(a, 0,1) * M(b, 3, 0) + M(a, 1,1) * M(b, 3, 1) + M(a, 2,1) * M(b, 3, 2) + M(a, 3,1) * M(b, 3,3);

  M(result, 0,2) = M(a, 0,2) * M(b, 0, 0) + M(a, 1,2) * M(b, 0, 1) + M(a, 2,2) * M(b, 0, 2) + M(a, 3,2) * M(b, 0,3);
  M(result, 1,2) = M(a, 0,2) * M(b, 1, 0) + M(a, 1,2) * M(b, 1, 1) + M(a, 2,2) * M(b, 1, 2) + M(a, 3,2) * M(b, 1,3);
  M(result, 2,2) = M(a, 0,2) * M(b, 2, 0) + M(a, 1,2) * M(b, 2, 1) + M(a, 2,2) * M(b, 2, 2) + M(a, 3,2) * M(b, 2,3);
  M(result, 3,2) = M(a, 0,2) * M(b, 3, 0) + M(a, 1,2) * M(b, 3, 1) + M(a, 2,2) * M(b, 3, 2) + M(a, 3,2) * M(b, 3,3);

  M(result, 0,3) = M(a, 0,3) * M(b, 0, 0) + M(a, 1,3) * M(b, 0, 1) + M(a, 2,3) * M(b, 0, 2) + M(a, 3,3) * M(b, 0,3);
  M(result, 1,3) = M(a, 0,3) * M(b, 1, 0) + M(a, 1,3) * M(b, 1, 1) + M(a, 2,3) * M(b, 1, 2) + M(a, 3,3) * M(b, 1,3);
  M(result, 2,3) = M(a, 0,3) * M(b, 2, 0) + M(a, 1,3) * M(b, 2, 1) + M(a, 2,3) * M(b, 2, 2) + M(a, 3,3) * M(b, 2,3);
  M(result, 3,3) = M(a, 0,3) * M(b, 3, 0) + M(a, 1,3) * M(b, 3, 1) + M(a, 2,3) * M(b, 3, 2) + M(a, 3,3) * M(b, 3,3);
*/
  return result;
